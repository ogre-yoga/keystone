...
- **JavaScript/TypeScript** for programming Keystone. We’ll stick with JavaScript in this series, but you can also benefit from Keystone’s TypeScript capabilities
...
Keystone looks for a file named `keystone` at the project root to handle configuration needs. Let's go ahead and set one up using TypeScript:
...
Like lists, they’ll be used in Admin UI for field label defaults, and in the GraphQL API.
...
![Terminal dialog showing successful Keystone startup](/assets/walkthroughs/lesson-1/keystone-startup.png)
...
![Adding a user record in Keystone Admin UI](/assets/walkthroughs/lesson-1/first-user-creation.gif)
